...
i wanna make it easier for future rust devs to make an os. there arent that many good tutorials and resources are lacking if you cant piece together the [osdev wiki](https://wiki.osdev.org/)
